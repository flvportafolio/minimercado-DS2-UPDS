        ...
        <nav id="sidebarMenu" class="col-md-2 d-md-block bg-light collapse">
          <div class="pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item py-2">
                <a class="nav-link active font-weight-bold" href="?ruta=usuario">Usuarios</a>
              </li>
        ...
        <main role="main" class="col-md-10" style="overflow-y: auto; height:600px;">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="crear_usuarios1" role="tabpanel" aria-labelledby="crear_usuarios1-tab">
              ...
              <form class="border border-dark rounded px-2 py-2 mt-2" method="post" action="?ruta=usuario&accion=newadmin" enctype="multipart/form-data">              
